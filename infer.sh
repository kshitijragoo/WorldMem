...
python -m main +name=infer \
    ...
    +dataset.selected_videos='["wo_updown_000001","wo_updown_000002","wo_updown_000003","w_updown_000001","w_updown_000002","w_updown_000003"]' \
    ...
    +algorithm.condition_index_method=knn \
